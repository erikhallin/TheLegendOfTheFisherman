...
bool particle_engine::update(void)
{
    for(int part_i=0;part_i<_max_particles;part_i++)
    {
        ...
        {
            //update age
            m_arr_particles[part_i].time_left-=_game_update_step*0.001;
            //update pos
            m_arr_particles[part_i].pos[0]+=(m_arr_particles[part_i].speed[0])*_game_update_step*0.001;
            m_arr_particles[part_i].pos[1]+=(m_arr_particles[part_i].speed[1])*_game_update_step*0.001;
            //update color
...
bool particle_engine::draw(void)
{
    ...
    for(int part_i=0;part_i<_max_particles;part_i++)
    {
        ...
        {
            glColor3f(m_arr_particles[part_i].color[0]*m_arr_particles[part_i].time_left/m_arr_particles[part_i].time_start,
                      m_arr_particles[part_i].color[1]*m_arr_particles[part_i].time_left/m_arr_particles[part_i].time_start,
                      m_arr_particles[part_i].color[2]*m_arr_particles[part_i].time_left/m_arr_particles[part_i].time_start);
...
bool particle_engine::add_explosion(float color[3],float pos[2],int numof_part,float force,float life_time,float direction_angle)
{
